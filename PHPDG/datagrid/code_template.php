<?php
    ...
    */
    ...
    ################################################################################
    ## --------------------------------------------------------------------------- #
    ##  ApPHP DataGrid Pro (AJAX enabled) version 8.3.9                            #
    ...
    ## *** delete all caching pages (only if you need to delete cache)
    /// $dgrid->DeleteCache();
    ##
    ## +-- Languages --------------------------------------------------------------+
    ...
    /// $multirow_view_type = 'icons'; /* optional - 'icons' or 'dropdownlist' */
    /// $dgrid->AllowMultirowOperations($multirow_option, $multirow_view_type);
    /// $multirow_operations = array(
    ///     'edit'    => array('view'=>true),
    ///     'details' => array('view'=>true),
    ///     'clone'   => array('view'=>false),
    ///     'delete'  => array('view'=>true),
	///     'exchange' => array('view'=>true,  'fields'=>array('field1', 'field2')),
    ...
    ##  *** set auto-generated columns in view mode true or false(default)
    ...
    ///     'FieldName_2'  =>array('header'=>'Name_B', 'type'=>'textarea',   'req_type'=>'rt', 'width'=>'210px', 'title'=>'', 'readonly'=>'false', 'maxlength'=>'-1', 'default'=>'', 'unique'=>'false', 'unique_condition'=>'', 'visible'=>'true', 'on_js_event'=>'', 'edit_type'=>'simple|wysiwyg', 'resizable'=>'both|horizontal|vertical|none', 'upload_images'=>'false', 'rows'=>'7', 'cols'=>'50'),
    ...
    ///     'FieldName_10' =>array('header'=>'Name_J', 'type'=>'enum',       'req_type'=>'st', 'width'=>'',      'title'=>'', 'readonly'=>'false', 'maxlength'=>'-1', 'default'=>'', 'unique'=>'false', 'unique_condition'=>'', 'visible'=>'true', 'on_js_event'=>'', 'source'=>'self'|$fill_from_array, 'view_type'=>'dropdownlist(default)|radiobutton|checkbox', 'elements_alignment'=>'horizontal|vertical', 'multiple'=>'false', 'multiple_size'=>'4'),
    ...
    ///     'FieldName_12' =>array('header'=>'Name_L', 'type'=>'checkbox',   'req_type'=>'st', 'width'=>'',      'title'=>'', 'readonly'=>'false', 'maxlength'=>'-1', 'default'=>'', 'unique'=>'false', 'unique_condition'=>'', 'visible'=>'true', 'on_js_event'=>'', 'true_value'=>1, 'false_value'=>0),
    ...
    ##  *** set auto-generated columns in edit mode: true or false(default)
    ...
    ##  --//--   : summarizeFunction        = ''; defines global aggregate function: SUM_TIME, SUM, AVG, MAX or MIN
    ...
    ##  --//--   : initFilteringState       = 'closed|opened'; defines initial state of filtering block - 'closed' or 'opened'
    ##  --//--   : dtSeparator              = '-'; defines a separator for datetime fields (private property, allowed values: -,/,- or :)
    ##  --//--   : maximumAllowedRecords    = '100'; defines a maximum number of allowed records to be inserted
    ...
    ##  --//--   : addBackQuotes            = true; // encloses table and field names with backquotes (private property, allowed values: true or false)
    ##  --//--   : accessKeys               = array(); // defines array of "accessKeys" for mode butons. Ex.: array('add'=>'a', 'edit'=>'e', 'cancel'=>'c', 'details'=>'v', 'update'=>'u', 'delete'=>'d');
    ##  --//--   : exportingDirectory       = ''; defines exporting directory (default 'tmp/export/')
    ##  --//--   : drawElementIdInViewMode  = true|false; defines whether to add ID attribute for elements in View mode
    ##  --//--   : filteringHideIconAllowed = true|false; defines whether to allow hide icon in filtering mode
    ##  --//--   : refreshPageIconAllowed   = true|false; defines whether to allow refresh page icon
    ...
    ##             $presidents = $dgrid->SelectSqlItem('SELECT COUNT(tblPresidents.presidentID) FROM tblPresidents WHERE tblPresidents.CountryID = '.(int)$_GET['f_rid']);
    ...
    ##  --//--   : 'summarize_function' => 'SUM|AVG|MAX|MIN|SUM_TIME' defines aggregate function for certain field
    ...
    ##  --//--   : 'default_null'   => 'true' defines whether to allow using of NULL for empty fields as default value
    ##  --//--   : 'save_as'        => 'standard|blob' (default - standard) defines a type of file storage - standard (link) or blob (for 'file' types)
    ##                                  additional parameters: 'blob_filetype'=>'', 'blob_filename'=>'', 'blob_filesize'=>'' - specifies additional fields (must be defined in database table)
    ##  --//--   : 'placeholder'    => '' defines a placeholder for text fields in Add/Edit modes and Filtering section
    ##  --//--   : 'condition_mode' => '' defines a mode, where condition for foreign keys will work
    ##
