...
/* ---------------------------------------------------------------------- *\
Changes by ApPHP:
#001. [16.05.2011] - added new icon insert datetime
#002. [11.08.2011] - commented to prevent JS error in FF and IE
...
\* ---------------------------------------------------------------------- */
	...
	"insertdatetime": ['InsertDateTime',       'InsertDateTime',     imagesDir + 'insert_date.gif',        imagesDir + 'insert_date_on.gif'],
...
\* ---------------------------------------------------------------------- */
function generate_wysiwyg(textareaID, upload_image) {
    // Hide the textarea 
    document.getElementById(textareaID).style.display = 'none';
	upload_image = (upload_image != null) ? upload_image : false;
    ...
    var toolbar;
    toolbar =  '<table cellpadding="0" cellspacing="0" border="0" class="toolbar1" style="width:' + toolbarWidth + 'px;"><tr><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="icon" hspace="3"></td>';
    ...
    var toolbar2;
    toolbar2 = '<table cellpadding="0" cellspacing="0" border="0" class="toolbar2" style="width:' + toolbarWidth + 'px;"><tr><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="seperator" hspace="3"></td>';
        ...
        if (buttonName2[j]) {
			...
			if (buttonName2[j] == "seperator") {
			  ...
			  toolbar2 += '</td>';
				...
				toolbar2 += '<td style="width: 22px;"><img src="' +buttonImage+ '" border=0 unselectable="on" title="' +buttonTitle+ '" id="' +buttonID+ '" class="button" onClick="formatText(this.id,\'' + n + '\', \'\', ' + upload_image + ');" onmouseover="if(className==\'button\'){className=\'buttonOver\'}; this.src=\'' +buttonImageRollover+ '\';" onmouseout="if(className==\'buttonOver\'){className=\'button\'}; this.src=\'' + buttonImage + '\';" unselectable="on" width="20" height="20"></td>';
			}
        }
        j++;
    }
...
\* ---------------------------------------------------------------------- */
function formatText(id, n, selected, upload_image) {    
    ...
    var formatIDs = new Array("FontSize","FontName","Bold","Italic","Underline","Subscript","Superscript","Strikethrough","Justifyleft","Justifyright","Justifycenter","InsertUnorderedList","InsertOrderedList","Indent","Outdent","ForeColor","BackColor","InsertImage","InsertTable","CreateLink","InsertDateTime");
	...
	// InsertImage
		...
		if(upload_image == true){
			window.open(addonsDir + 'imagelibrary/insert_image.php?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=603,height=250');			
		}else{
			window.open(popupsDir + 'insert_image.html?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=400,height=195');			
		}        
	}  
	// InsertTable
	...
	// InsertDateTime
	else if (id == "InsertDateTime") {
		var d = new Date();
		var hh = d.getHours();  var hour = (hh < 10) ? '0' + hh : hh;
		var ii = d.getMinutes();  var minite = (ii < 10) ? '0' + ii : ii;
		var ss = d.getSeconds(); var second = (ss < 10) ? '0' + ss : ss;		
		var dd = d.getDate();   var day = (dd < 10) ? '0' + dd : dd;
		var mm = d.getMonth()+1; var month = (mm < 10) ? '0' + mm : mm;
		var yy = d.getYear();    var year = (yy < 1000) ? yy + 1900 : yy;
		
        window.insertHTML(year+'-'+month+'-'+day+' '+hour+':'+minite+':'+second, n);
	}
	// ViewSource
