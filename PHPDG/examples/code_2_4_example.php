...
<html>
  <head>
    ...
    <title>ApPHP DataGrid :: Sample #2-4 (code) - Customized layout in Details Mode</title>
  </head>
<body>
...
<?php
    ...
    ##  *** set layouts: 0 - tabular(horizontal) - default, 1 - columnar(vertical) 
     ...
     $details_template['body'] = "        
        <table dir='ltr' class='x-blue_dg_table' style='margin:0 auto;width:60%;140px'>
        ...
        <br>
        <table dir='ltr' style='margin:0 auto;width:60%;140px'>
        <tr class='class_tr'>    
    ...
    ##  *** "byFieldValue"=>"fieldName" - make the field to be a link to edit mode page
     $modes = array(
        ...
        "details" =>array("view"=>true, "edit"=>false, "type"=>"image"),
    ...
    ##  *** array("unique_prefix"=>array("view"=>true|false, "edit"=>true|false, "details"=>true|false));
     $otherDatagrids = array("fp_"=>array("view"=>false, "edit"=>true, "details"=>false));
    ...
    ##  *** set aditional filtering settings
      ...
      $filtering_fields = array(
        "Country"     =>array("type"=>"textbox", "table"=>"demo_countries", "field"=>"name", "source"=>"self", "operator"=>true, "default_operator"=>"like", "case_sensitive"=>true,  "comparison_type"=>"string"),
        "Region"      =>array("type"=>"enum",    "table"=>"demo_regions",   "field"=>"name", "source"=>"self", "order"=>"DESC", "operator"=>true, "case_sensitive"=>false,  "comparison_type"=>"binary"),
    ...
    if($mode == "edit"){
        ...
        ##  *** set exporting option: true(default) or false 
         ...
         $export_all = false;
         $dgrid1->AllowExporting($exporting_option, $export_all);
