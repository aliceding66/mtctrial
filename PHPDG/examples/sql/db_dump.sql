...
CREATE TABLE IF NOT EXISTS `demo_countries` (
  ...
  `independent_date` datetime NULL default NULL,
...
DROP TABLE IF EXISTS `demo_democracy`;
...
DROP TABLE IF EXISTS `demo_regions`;
...
) ENGINE=MyISAM  AUTO_INCREMENT=10367 ;
...
(307, '2008-01-15 22:03:17', 0),
(308, '2009-02-15 21:04:17', 0),
(309, '2009-03-15 21:05:17', 0),
(310, '2010-04-15 21:06:17', 0),
(311, '2011-05-15 21:07:17', 0);
INSERT INTO `demo_downloads` (`id`, `download_date`, `download_type`) VALUES (312, '2012-06-15 21:08:17', 0);


DROP TABLE IF EXISTS `demo_all_in_one`;
CREATE TABLE IF NOT EXISTS `demo_all_in_one` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `field_textbox` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `field_textarea` text COLLATE utf8_unicode_ci NOT NULL,
  `field_date` date NULL default NULL,
  `field_datetime` datetime NULL default NULL,
  `field_time` time DEFAULT '00:00:00',
  `field_image` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  `field_file` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  `field_money` decimal(10,2) NOT NULL DEFAULT '0.00',
  `field_foreign_key` smallint(6) unsigned NOT NULL DEFAULT '0',
  `field_enum` tinyint(1) NOT NULL DEFAULT '0',
  `field_enum_multiple` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `field_password` varchar(50) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `field_checkbox` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `field_color` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `field_percent` decimal(5,2) unsigned NOT NULL,
  `field_hidden` date DEFAULT NULL,
  `field_link` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=6 ;

INSERT INTO `demo_all_in_one` (`id`, `field_textbox`, `field_textarea`, `field_date`, `field_datetime`, `field_time`, `field_image`, `field_file`, `field_money`, `field_foreign_key`, `field_enum`, `field_enum_multiple`, `field_password`, `field_checkbox`, `field_color`, `field_percent`, `field_hidden`, `field_link`) VALUES
(1, 'Maecenas imperdiet', 'Proin fermentum elementum porta. In hac habitasse platea dictumst. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Vivamus odio neque, venenatis quis dignissim sed, lobortis in sem', '2011-10-19', '2011-10-19 18:51:02', '18:51:02', '', '', '88.50', 120, 0, '', '˜Ö®Øã\r2a/½—ž+ÿ²', 1, '#FFADD3', '3.99', '2011-10-19', 'http://'),
(2, 'Pellentesque in felis eros', 'Etiam sit amet nulla porta purus ullamcorper congue. Pellentesque mollis luctus dolor, ut gravida arcu tristique pretium. Ut fringilla ipsum ut urna laoreet nec aliquet ante aliquam. Proin rhoncus accumsan massa. Phasellus tincidunt sem at nibh scelerisque porttitor. Morbi non arcu ac sem ultrices dictum. Phasellus fringilla massa vitae mi interdum adipiscing. Sed nec augue orci, vitae eleifend augue', '2011-10-19', '2011-10-19 18:49:25', '18:49:25', '', '', '55.00', 120, 1, '', '˜Ö®Øã\r2a/½—ž+ÿ²', 0, '#3888FF', '33.50', '2011-10-19', 'http://'),
(3, 'Lorem ipsum dolor', 'Maecenas porta lacus a magna rhoncus eu ornare dui aliquam. Nam lacinia risus sed nisi elementum eu sagittis nunc mattis. Nam vestibulum convallis ultrices. Aenean non est dolor. Vivamus eget tellus enim. Sed facilisis erat eu elit posuere posuere. Ut eget mollis nunc.', '2011-10-19', '2011-10-19 18:47:59', '18:47:59', '', '', '0.00', 82, 2, '', '»ŠiÂ·*fÎš§·>Å', 0, '#38FF59', '0.00', '2011-10-19', 'http://'),
(4, 'Maecenas est odio', 'Maecenas pharetra libero ipsum. Nullam dapibus risus nec tortor aliquet in eleifend turpis venenatis. Mauris posuere lorem vitae sapien porta eu accumsan purus vehicula. Quisque iaculis ligula velit. Pellentesque pellentesque, nulla eu tempus tempor', '2011-10-19', '2011-10-19 19:09:39', '19:09:39', '', '', '55.00', 165, 3, '', '˜Ö®Øã\r2a/½—ž+ÿ²', 0, '#85FF89', '0.00', '2011-10-19', 'http://'),
(5, 'Morbi congue tortor', 'Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Pellentesque elementum dignissim fringilla. Aliquam tellus lorem, tincidunt ut adipiscing id, auctor sit amet tellus. Sed egestas aliquam eros, quis semper diam mattis vel. Mauris id facilisis nunc. Nunc lobortis pharetra eros quis auctor. Nulla facilisi. Nunc ullamcorper justo id quam auctor facilisis.', '2011-10-19', '2011-10-19 19:10:02', '19:10:02', '', '', '10.00', 78, 0, '', '˜Ö®Øã\r2a/½—ž+ÿ²', 1, '#FF6D2E', '0.00', '2011-10-19', 'http://');
