...
<html>
  <head>
    ...
    <title>ApPHP DataGrid :: Sample #1-2 (code)</title>
  </head>
...
<?php
    ...
    ##  *** array("unique_prefix"=>array("view"=>true|false, "edit"=>true|false, "details"=>true|false));
     ...
     $dgrid->SetOtherDatagrids($anotherDatagrids);  
    ##  *** set DataGrid caption
     $dg_caption = '<b>Simple ApPHP DataGrid - <a href=index.php>Back to Index</a>';
    ...
    ##  *** set aditional filtering settings
      ...
      $filtering_fields = array(
        "Region"      =>array("type"=>"enum",    "table"=>"demo_regions",   "field"=>"id", "field_view"=>"name", "source"=>"self", "order"=>"DESC", "default_operator"=>"=", "default"=>$sel_region, "on_js_event"=>"onchange='".$unique_prefix."_doPostBack(\"reset\", 0, \"&sel_region=\"+this.value)'"),
        "Country"     =>array("type"=>"enum",    "table"=>"demo_countries", "field"=>"id", "field_view"=>"name", "source"=>"self", "order"=>"DESC", "default_operator"=>"=", "condition"=>$country_condition),
        ...
        "Population"  =>array("type"=>"enum",    "table"=>"demo_countries", "field"=>"population", "source"=>$fill_from_array, "order"=>"DESC", "operator"=>true, "case_sensitive"=>false, "comparison_type"=>"numeric")
      );
    ...
    if(($mode == "edit") || ($mode == "details")){
        ...
        ##  *** format (in wich mode to allow processing of another datagrids)
        ##  *** array("unique_prefix"=>array("view"=>true|false, "edit"=>true|false, "details"=>true|false));
          $otherDatagrids = array("f_"=>array("view"=>true, "edit"=>true, "details"=>true));
          $dgrid1->SetOtherDatagrids($otherDatagrids);  
        ##  *** set DataGrid caption
        ...
        /// $fill_from_array = array("0"=>"No", "1"=>"Yes", "2"=>"Don't know", "3"=>"My be"); /* as "value"=>"option" */
         $em_columns = array(
            ...
            "status"     =>array("header"=>"Status",     "type"=>"enum",     "req_type"=>"st", "width"=>"", "title"=>"Status", "readonly"=>false, "maxlength"=>"-1", "default"=>"", "unique"=>false, "unique_condition"=>"", "on_js_event"=>"", "source"=>"self", "view_type"=>"dropdownlist")
         );
        ...
        ##  *** Ex.: "on_js_event"=>"onclick='alert(\"Yes!!!\");'"
         $foreign_keys = array(
            "country_id"=>array("table"=>"demo_countries", "field_key"=>"id", "field_name"=>"name", "view_type"=>"dropdownlist", "elements_alignment"=>"horizontal|vertical", "condition"=>"id=".$rid, "order_by_field"=>"name", "order_type"=>"ASC|DESC", "on_js_event"=>""),      
